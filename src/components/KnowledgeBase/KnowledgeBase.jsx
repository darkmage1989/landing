  ...
  return (
    <section className={style.knowledge__base}>
      <article className={style.knowledge__box}>
        <Knowledge color={'#CDE0A4'} text={"Биология"} />
        <Knowledge color={'#D4DDEE'} text={"Химия"} />
        <Knowledge color={'#F9E48A'} text={"Русский язык"} />
        <Knowledge color={'#B3D4E5'} text={"Профильная математика"} />
        <Knowledge color={'#ACD5B7'} text={"Обществознание"} />
        <Knowledge color={'#F5C6AA'} text={"История"} />
        <Knowledge color={'#76C1C1'} text={"Физика"} />
        <Knowledge color={'#F4BE9A'} text={"Литература"} />
        <Knowledge color={'#DBDBDB'} text={"Информатика"} />
        <Knowledge color={'#7CB8E0'} text={"Английский язык"} />
        <Knowledge color={'#A3D8AF'} text={"География"} />
        <Knowledge color={'#B3D4E5'} text={"Базовая математика"} />
      </article>
      <article className={style.knowledge__text__box}>
        <h3 className={style.knowledge__text__box__title}>
          Банк заданий по всем предметам
        </h3>
        <span className={style.knowledge__text__box__middle}>
        ...
        <svg className={style.knowledge__arrow}
